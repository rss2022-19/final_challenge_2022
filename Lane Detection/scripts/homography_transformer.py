...
from final_challenge_2022.msg import GoalPixel, GoalPoint
...
class HomographyTransformer:
    def __init__(self):
        self.cone_px_sub = rospy.Subscriber("/relative_cone_px", GoalPixel, self.cone_detection_callback)
        self.cone_pub = rospy.Publisher("/relative_cone", GoalPoint, queue_size=10)
...
if __name__ == "__main__":
    ...
    print("x,y = ", homography_transformer.transformUvToXy(183, 82))
    rospy.spin()
